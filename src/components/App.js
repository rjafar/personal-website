...
var app = {
  ...
  initParallaxScene: function() {
    ...
    var tween = new TimelineMax ().add([
      ...
      TweenMax.fromTo("#art-5", 0.5, {y:0, ease: Linear.easeNone}, {y: 300, ease: Linear.easeNone}), //galaxy
      TweenMax.fromTo("#art-6", 0.5, {y:0, ease: Linear.easeNone}, {y: -800, ease: Linear.easeNone}), //lightgrass
      TweenMax.fromTo("#art-7", 0.5, {y:0, ease: Linear.easeNone}, {y: -900, ease: Linear.easeNone}), //darkgrass
      TweenMax.fromTo("#art-8", 0.5, {y:0, ease: Linear.easeNone}, {y: -1008, ease: Linear.easeNone}), //silhouette
  ...
  return (
    <section id="art-section">
      <div className="art">
        ...
        <div id="art-5" className="art--layer" style={{backgroundImage: 'url("images/art/galaxy.svg")', zIndex: '5'}}></div>
        <div id="art-6" className="art--layer" style={{backgroundImage: 'url("images/art/light-grass.svg")', zIndex: '6'}}></div>
        <div id="art-7" className="art--layer" style={{backgroundImage: 'url("images/art/dark-grass.svg")', zIndex: '7'}}></div>
        <div id="art-8" className="art--layer" style={{backgroundImage: 'url("images/art/silhouette.svg")', zIndex: '8'}}></div>

        <div className="art--layer project-slide__logo animate__animated animate__flipInX" id="art-logo">
          <span>Welcome</span>
        </div>
      </div>
    </section>
